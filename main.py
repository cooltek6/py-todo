'''
project: CoolTek ToDo List
filename: main.py
by: cooltek-6 actual
for: cooltek and the coolkidz
from: framework @techvidvan
scope: tkinter desktop gui
date: 8-5-23
revised: 8-9-23 comment: added to a GitHub repository
'''
...
root = Tk()
root.title('CoolTek To-Do List')
root.geometry('300x400')
root.resizable(0, 0)
root.config(bg="PaleVioletRed")

# Heading Label
Label(root, text='The Daily Running BuJo', bg='PaleVioletRed', font=("Comic Sans MS", 15), wraplength=300).place(x=35, y=0)
